...
<head>
    ...
    <title>Hand & Wrist Pain Treatment in Goa | Impact Ortho</title>
    <meta name="description" content="Expert Hand & Wrist Pain Treatment in Goa. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta name="keywords" content="hand & wrist pain treatment in goa, best hand & wrist pain treatment goa, orthopedic specialist goa" />
    <link rel="canonical" href="https://www.impactorthocenter.com/hand-wrist-pain-in-goa" />
    <meta name="robots" content="index, follow" />

    <!-- Open Graph -->
    <meta property="og:title" content="Hand & Wrist Pain Treatment in Goa | Impact Ortho" />
    <meta property="og:description" content="Expert Hand & Wrist Pain Treatment in Goa. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta property="og:url" content="https://www.impactorthocenter.com/hand-wrist-pain-in-goa" />
    ...
    <meta name="twitter:title" content="Hand & Wrist Pain Treatment in Goa | Impact Ortho" />
    <meta name="twitter:description" content="Expert Hand & Wrist Pain Treatment in Goa. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    ...
    "@type": "MedicalTherapy",
    "name": "Hand & Wrist Pain Treatment in Goa",
    "description": "Advanced hand & wrist pain treatment for patients in Goa at Impact Ortho Centre, Hyderabad.",
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="hero-content">
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            Hand & Wrist Pain Treatment <span class="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">in Goa</span>
                        </h1>
                        <p class="text-xl text-gray-700 mb-8 leading-relaxed">
                            Experience world-class orthopedic care at Impact Ortho Centre in Hyderabad. We serve patients from Goa with advanced hand & wrist pain treatment solutions, expert surgeons, and comprehensive rehabilitation programs for optimal recovery.
                        </p>
                    ...
                    <div class="hero-image relative">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://impactorthocenter.com/photos/Hand-Wrist-Pain.webp" alt="Hand & Wrist Pain Treatment in Goa" class="w-full h-auto object-cover" />
