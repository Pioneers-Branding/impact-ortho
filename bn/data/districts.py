...
# Data source: Compiled list of districts for Indian States & UTs
...
DISTRICTS = {
    ...
    "Hyderabad": ["Hyderabad"] # Hyderabad is a district itself in Telangana but listed as separate link page earlier
}
