...
<head>
    ...
    <title>Knee Replacement in Andaman and Nicobar Islands | Impact</title>
    <meta name="description" content="Expert Knee Replacement in Andaman and Nicobar Islands. Advanced orthopedic care at Impact Ortho Centre. Book consultation!" />
    <meta name="keywords" content="knee replacement in andaman and nicobar islands, best knee replacement andaman and nicobar islands, orthopedic specialist andaman and nicobar islands" />
    <link rel="canonical" href="https://www.impactorthocenter.com/knee-replacement-in-andaman-and-nicobar-islands" />
    <meta name="robots" content="index, follow" />

    <!-- Open Graph -->
    <meta property="og:title" content="Knee Replacement in Andaman and Nicobar Islands | Impact" />
    <meta property="og:description" content="Expert Knee Replacement in Andaman and Nicobar Islands. Advanced orthopedic care at Impact Ortho Centre. Book consultation!" />
    <meta property="og:url" content="https://www.impactorthocenter.com/knee-replacement-in-andaman-and-nicobar-islands" />
    ...
    <meta name="twitter:title" content="Knee Replacement in Andaman and Nicobar Islands | Impact" />
    <meta name="twitter:description" content="Expert Knee Replacement in Andaman and Nicobar Islands. Advanced orthopedic care at Impact Ortho Centre. Book consultation!" />
    ...
    "name": "Knee Replacement in Andaman and Nicobar Islands",
    "description": "Advanced knee replacement for patients in Andaman and Nicobar Islands at Impact Ortho Centre, Hyderabad.",
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="hero-content">
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            Knee Replacement <span class="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">in Andaman and Nicobar Islands</span>
                        </h1>
                        <p class="text-xl text-gray-700 mb-8 leading-relaxed">
                            Experience world-class orthopedic care at Impact Ortho Centre in Hyderabad. We serve patients from Andaman and Nicobar Islands with advanced knee replacement solutions, expert surgeons, and comprehensive rehabilitation programs for optimal recovery.
                        </p>
                    ...
                    <div class="hero-image relative">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://impactorthocenter.com/photos/Knee-Replacement.webp" alt="Knee Replacement in Andaman and Nicobar Islands" class="w-full h-auto object-cover" />
