...
def update_sitemap():
    ...
    # Find all geneated Hospital PHP files (state and district)
    # They all start with orthopedic-hospital-in-
    files_to_add = glob.glob('orthopedic-hospital-in-*.php')
    print(f"Found {len(files_to_add)} hospital files on disk.")
