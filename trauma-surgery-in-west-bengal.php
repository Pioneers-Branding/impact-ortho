...
<head>
    ...
    <title>Trauma Surgery in West Bengal | Impact Ortho</title>
    <meta name="description" content="Expert Trauma Surgery in West Bengal. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta name="keywords" content="trauma surgery in west bengal, best trauma surgery west bengal, orthopedic specialist west bengal" />
    <link rel="canonical" href="https://www.impactorthocenter.com/trauma-surgery-in-west-bengal" />
    <meta name="robots" content="index, follow" />

    <!-- Open Graph -->
    <meta property="og:title" content="Trauma Surgery in West Bengal | Impact Ortho" />
    <meta property="og:description" content="Expert Trauma Surgery in West Bengal. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta property="og:url" content="https://www.impactorthocenter.com/trauma-surgery-in-west-bengal" />
    ...
    <meta name="twitter:title" content="Trauma Surgery in West Bengal | Impact Ortho" />
    <meta name="twitter:description" content="Expert Trauma Surgery in West Bengal. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    ...
    "name": "Trauma Surgery in West Bengal",
    "description": "Advanced trauma surgery for patients in West Bengal at Impact Ortho Centre, Hyderabad.",
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="hero-content">
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            Trauma Surgery <span class="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">in West Bengal</span>
                        </h1>
                        <p class="text-xl text-gray-700 mb-8 leading-relaxed">
                            Experience world-class orthopedic care at Impact Ortho Centre in Hyderabad. We serve patients from West Bengal with advanced trauma surgery solutions, expert surgeons, and comprehensive rehabilitation programs for optimal recovery.
                        </p>
                    ...
                    <div class="hero-image relative">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://impactorthocenter.com/photos/Trauma-Fracture.webp" alt="Trauma Surgery in West Bengal" class="w-full h-auto object-cover" />
