...
<head>
    ...
    <title>Neck Pain Treatment in Sikkim | Impact Ortho</title>
    <meta name="description" content="Expert Neck Pain Treatment in Sikkim. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta name="keywords" content="neck pain treatment in sikkim, best neck pain treatment sikkim, orthopedic specialist sikkim" />
    <link rel="canonical" href="https://www.impactorthocenter.com/neck-pain-in-sikkim" />
    <meta name="robots" content="index, follow" />

    <!-- Open Graph -->
    <meta property="og:title" content="Neck Pain Treatment in Sikkim | Impact Ortho" />
    <meta property="og:description" content="Expert Neck Pain Treatment in Sikkim. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta property="og:url" content="https://www.impactorthocenter.com/neck-pain-in-sikkim" />
    ...
    <meta name="twitter:title" content="Neck Pain Treatment in Sikkim | Impact Ortho" />
    <meta name="twitter:description" content="Expert Neck Pain Treatment in Sikkim. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    ...
    "@type": "MedicalTherapy",
    "name": "Neck Pain Treatment in Sikkim",
    "description": "Advanced neck pain treatment for patients in Sikkim at Impact Ortho Centre, Hyderabad.",
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="hero-content">
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            Neck Pain Treatment <span class="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">in Sikkim</span>
                        </h1>
                        <p class="text-xl text-gray-700 mb-8 leading-relaxed">
                            Experience world-class orthopedic care at Impact Ortho Centre in Hyderabad. We serve patients from Sikkim with advanced neck pain treatment solutions, expert surgeons, and comprehensive rehabilitation programs for optimal recovery.
                        </p>
                    ...
                    <div class="hero-image relative">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://impactorthocenter.com/photos/logo-1-impact.webp" alt="Neck Pain Treatment in Sikkim" class="w-full h-auto object-cover" />
