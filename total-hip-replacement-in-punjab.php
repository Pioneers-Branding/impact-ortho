...
<head>
    ...
    <title>Total Hip Replacement in Punjab | Impact Ortho</title>
    <meta name="description" content="Expert Total Hip Replacement in Punjab. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta name="keywords" content="total hip replacement in punjab, best total hip replacement punjab, orthopedic specialist punjab" />
    <link rel="canonical" href="https://www.impactorthocenter.com/total-hip-replacement-in-punjab" />
    <meta name="robots" content="index, follow" />

    <!-- Open Graph -->
    <meta property="og:title" content="Total Hip Replacement in Punjab | Impact Ortho" />
    <meta property="og:description" content="Expert Total Hip Replacement in Punjab. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta property="og:url" content="https://www.impactorthocenter.com/total-hip-replacement-in-punjab" />
    ...
    <meta name="twitter:title" content="Total Hip Replacement in Punjab | Impact Ortho" />
    <meta name="twitter:description" content="Expert Total Hip Replacement in Punjab. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    ...
    "name": "Total Hip Replacement in Punjab",
    "description": "Advanced total hip replacement for patients in Punjab at Impact Ortho Centre, Hyderabad.",
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="hero-content">
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            Total Hip Replacement <span class="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">in Punjab</span>
                        </h1>
                        <p class="text-xl text-gray-700 mb-8 leading-relaxed">
                            Experience world-class orthopedic care at Impact Ortho Centre in Hyderabad. We serve patients from Punjab with advanced total hip replacement solutions, expert surgeons, and comprehensive rehabilitation programs for optimal recovery.
                        </p>
                    ...
                    <div class="hero-image relative">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://impactorthocenter.com/photos/Hip-Replacement.webp" alt="Total Hip Replacement in Punjab" class="w-full h-auto object-cover" />
