...
<head>
    ...
    <title>Arthroscopy in Andhra Pradesh | Impact Ortho</title>
    <meta name="description" content="Expert Arthroscopy in Andhra Pradesh. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta name="keywords" content="arthroscopy in andhra pradesh, best arthroscopy andhra pradesh, orthopedic specialist andhra pradesh" />
    <link rel="canonical" href="https://www.impactorthocenter.com/arthroscopy-in-andhra-pradesh" />
    <meta name="robots" content="index, follow" />

    <!-- Open Graph -->
    <meta property="og:title" content="Arthroscopy in Andhra Pradesh | Impact Ortho" />
    <meta property="og:description" content="Expert Arthroscopy in Andhra Pradesh. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta property="og:url" content="https://www.impactorthocenter.com/arthroscopy-in-andhra-pradesh" />
    ...
    <meta name="twitter:title" content="Arthroscopy in Andhra Pradesh | Impact Ortho" />
    <meta name="twitter:description" content="Expert Arthroscopy in Andhra Pradesh. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    ...
    "name": "Arthroscopy in Andhra Pradesh",
    "description": "Advanced arthroscopy for patients in Andhra Pradesh at Impact Ortho Centre, Hyderabad.",
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="hero-content">
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            Arthroscopy <span class="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">in Andhra Pradesh</span>
                        </h1>
                        <p class="text-xl text-gray-700 mb-8 leading-relaxed">
                            Experience world-class orthopedic care at Impact Ortho Centre in Hyderabad. We serve patients from Andhra Pradesh with advanced arthroscopy solutions, expert surgeons, and comprehensive rehabilitation programs for optimal recovery.
                        </p>
                    ...
                    <div class="hero-image relative">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://impactorthocenter.com/photos/Arthroscopy-Surgery.webp" alt="Arthroscopy in Andhra Pradesh" class="w-full h-auto object-cover" />
