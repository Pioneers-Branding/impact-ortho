...
<head>
    ...
    <title>Avascular Necrosis Treatment in Haryana | Impact Ortho</title>
    <meta name="description" content="Expert Avascular Necrosis Treatment in Haryana. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta name="keywords" content="avascular necrosis treatment in haryana, best avascular necrosis treatment haryana, orthopedic specialist haryana" />
    <link rel="canonical" href="https://www.impactorthocenter.com/avascular-necrosis-in-haryana" />
    <meta name="robots" content="index, follow" />

    <!-- Open Graph -->
    <meta property="og:title" content="Avascular Necrosis Treatment in Haryana | Impact Ortho" />
    <meta property="og:description" content="Expert Avascular Necrosis Treatment in Haryana. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta property="og:url" content="https://www.impactorthocenter.com/avascular-necrosis-in-haryana" />
    ...
    <meta name="twitter:title" content="Avascular Necrosis Treatment in Haryana | Impact Ortho" />
    <meta name="twitter:description" content="Expert Avascular Necrosis Treatment in Haryana. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    ...
    "name": "Avascular Necrosis Treatment in Haryana",
    "description": "Advanced avascular necrosis treatment for patients in Haryana at Impact Ortho Centre, Hyderabad.",
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="hero-content">
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            Avascular Necrosis Treatment <span class="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">in Haryana</span>
                        </h1>
                        <p class="text-xl text-gray-700 mb-8 leading-relaxed">
                            Experience world-class orthopedic care at Impact Ortho Centre in Hyderabad. We serve patients from Haryana with advanced avascular necrosis treatment solutions, expert surgeons, and comprehensive rehabilitation programs for optimal recovery.
                        </p>
                    ...
                    <div class="hero-image relative">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://impactorthocenter.com/photos/Avascular-Necrosis.webp" alt="Avascular Necrosis Treatment in Haryana" class="w-full h-auto object-cover" />
