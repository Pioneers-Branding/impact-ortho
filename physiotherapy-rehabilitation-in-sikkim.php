...
<head>
    ...
    <title>Physiotherapy & Rehabilitation in Sikkim | Impact Ortho</title>
    <meta name="description" content="Expert Physiotherapy & Rehabilitation in Sikkim. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta name="keywords" content="physiotherapy & rehabilitation in sikkim, best physiotherapy & rehabilitation sikkim, orthopedic specialist sikkim" />
    <link rel="canonical" href="https://www.impactorthocenter.com/physiotherapy-rehabilitation-in-sikkim" />
    <meta name="robots" content="index, follow" />

    <!-- Open Graph -->
    <meta property="og:title" content="Physiotherapy & Rehabilitation in Sikkim | Impact Ortho" />
    <meta property="og:description" content="Expert Physiotherapy & Rehabilitation in Sikkim. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    <meta property="og:url" content="https://www.impactorthocenter.com/physiotherapy-rehabilitation-in-sikkim" />
    ...
    <meta name="twitter:title" content="Physiotherapy & Rehabilitation in Sikkim | Impact Ortho" />
    <meta name="twitter:description" content="Expert Physiotherapy & Rehabilitation in Sikkim. Impact Ortho Centre offers advanced orthopedic care with experienced surgeons. Book consultation today!" />
    ...
    "@type": "MedicalTherapy",
    "name": "Physiotherapy & Rehabilitation in Sikkim",
    "description": "Advanced physiotherapy & rehabilitation for patients in Sikkim at Impact Ortho Centre, Hyderabad.",
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="hero-content">
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            Physiotherapy & Rehabilitation <span class="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">in Sikkim</span>
                        </h1>
                        <p class="text-xl text-gray-700 mb-8 leading-relaxed">
                            Experience world-class orthopedic care at Impact Ortho Centre in Hyderabad. We serve patients from Sikkim with advanced physiotherapy & rehabilitation solutions, expert surgeons, and comprehensive rehabilitation programs for optimal recovery.
                        </p>
                    ...
                    <div class="hero-image relative">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://impactorthocenter.com/photos/Physiotherapy-Rehabilitation.webp" alt="Physiotherapy & Rehabilitation in Sikkim" class="w-full h-auto object-cover" />
